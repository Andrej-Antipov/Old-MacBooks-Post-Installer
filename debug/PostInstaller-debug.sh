...
printf '  Введите пароль для продолжения: '
read -s PASSWORD
if [[ ! $PASSWORD = "" ]]; then 
if echo $PASSWORD | sudo -Sk printf '' 2>/dev/null; then 
    printf '\n\n  Пароль принят \n'
...
UNSET_SPINDUMP(){
sudo launchctl unload -w /System/Library/LaunchDaemons/com.apple.spindump.plist >> debug.txt 2> debug.txt
sudo mv /System/Library/LaunchDaemons/com.apple.spindump.plist /System/Library/LaunchDaemons/com.apple.spindump.plist.bak >> debug.txt 2> debug.txt
sudo launchctl unload -w /System/Library/LaunchDaemons/com.apple.tailspind.plist >> debug.txt 2> debug.txt
sudo mv /System/Library/LaunchDaemons/com.apple.tailspind.plist /System/Library/LaunchDaemons/com.apple.tailspind.plist.bak >> debug.txt 2> debug.txt
sleep 0.1

}

SET_SPINDUMP(){
sudo mv /System/Library/LaunchDaemons/com.apple.spindump.plist.bak /System/Library/LaunchDaemons/com.apple.spindump.plist >> debug.txt 2> debug.txt
sudo mv /System/Library/LaunchDaemons/com.apple.tailspind.plist.bak /System/Library/LaunchDaemons/com.apple.tailspind.plist >> debug.txt 2> debug.txt
sudo launchctl load -w /System/Library/LaunchDaemons/com.apple.spindump.plist >> debug.txt 2> debug.txt
sudo launchctl load -w /System/Library/LaunchDaemons/com.apple.tailspind.plist >> debug.txt 2> debug.txt
sleep 0.1
}
...
UNSET_ERROR_REPORT(){
sudo launchctl unload -w /System/Library/LaunchAgents/com.apple.ReportCrash.plist  >> debug.txt 2> debug.txt
sudo mv /System/Library/LaunchAgents/com.apple.ReportCrash.plist /System/Library/LaunchAgents/com.apple.ReportCrash.plist.back  >> debug.txt 2> debug.txt
sudo launchctl unload -w /System/Library/LaunchDaemons/com.apple.ReportCrash.Root.plist >> debug.txt 2> debug.txt
sudo mv /System/Library/LaunchDaemons/com.apple.ReportCrash.Root.plist /System/Library/LaunchDaemons/com.apple.ReportCrash.Root.plist.back >> debug.txt 2> debug.txt
sleep 0.1
}
...
UNSET_DASH(){
defaults write com.apple.dashboard mcx-disabled -boolean TRUE >> debug.txt 2> debug.txt
killall Dock
}

SET_DASH(){
defaults delete com.apple.dashboard mcx-disabled >> debug.txt 2> debug.txt
killall Dock >&- 2>&-
sleep 0.1
}
...
SET_AUTODOCK(){
defaults write com.apple.dock autohide-delay -float 0 >> debug.txt 2> debug.txt
defaults write com.apple.dock autohide-time-modifier -float 0 >> debug.txt 2> debug.txt
killall Dock
sleep 0.1
}

UNSET_AUTODOCK(){
defaults write com.apple.dock autohide-delay -float 1 >> debug.txt 2> debug.txt
defaults delete com.apple.dock autohide-time-modifier >> debug.txt 2> debug.txt
killall Dock 
sleep 0.1
}
...
UNSET_KEYS(){
rm -f ~/Library/KeyBindings/DefaultKeyBinding.dict >> debug.txt 2> debug.txt
}
...
sudo mv /System/Library/CoreServices/MRT.app /System/Library/CoreServices/MRT.app.bak >> debug.txt 2> debug.txt
sudo launchctl unload -w /System/Library/LaunchDaemons/com.apple.MRTd.plist >> debug.txt 2> debug.txt
sudo launchctl unload -w /System/Library/LaunchAgents/com.apple.MRTa.plist  >> debug.txt 2> debug.txt
sudo mv /System/Library/LaunchDaemons/com.apple.MRTd.plist /System/Library/LaunchDaemons/com.apple.MRTd.plist.bak >> debug.txt 2> debug.txt
sudo mv /System/Library/LaunchAgents/com.apple.MRTa.plist /System/Library/LaunchAgents/com.apple.MRTa.plist.bak >> debug.txt 2> debug.txt
}
...
if [[ -f /System/Library/LaunchDaemons/com.apple.MRTd.plist.bak ]]; then 
        sudo mv /System/Library/LaunchDaemons/com.apple.MRTd.plist.bak /System/Library/LaunchDaemons/com.apple.MRTd.plist >> debug.txt 2> debug.txt
        sudo launchctl load -w /System/Library/LaunchDaemons/com.apple.MRTd.plist >> debug.txt 2> debug.txt
fi
sleep 1
if [[ $(sudo ps xca | grep MRT | grep -oE '[^ ]+$' | tr -d " \n") = "MRT" ]]; then sudo killall MRT ; fi >> debug.txt 2> debug.txt
}
